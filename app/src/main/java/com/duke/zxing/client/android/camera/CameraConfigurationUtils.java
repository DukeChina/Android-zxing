...
package com.duke.zxing.client.android.camera;
...
public final class CameraConfigurationUtils {
    ...
    public static void setFocus(Camera.Parameters parameters, boolean autoFocus, boolean disableContinuous,
        ...
        if (autoFocus) {
            if (safeMode || disableContinuous) {
                ...
                focusMode =
                    findSettableValue("focus mode", supportedFocusModes,
        ...
        if (!safeMode && focusMode == null) {
            focusMode =
                findSettableValue("focus mode", supportedFocusModes, Camera.Parameters.FOCUS_MODE_MACRO,
    ...
    public static void setBarcodeSceneMode(Camera.Parameters parameters) {
        ...
        String sceneMode =
            findSettableValue("scene mode", parameters.getSupportedSceneModes(), Camera.Parameters.SCENE_MODE_BARCODE);
        if (sceneMode != null) {
    ...
    public static void setInvertColor(Camera.Parameters parameters) {
        ...
        String colorMode =
            findSettableValue("color effect", parameters.getSupportedColorEffects(), Camera.Parameters.EFFECT_NEGATIVE);
        if (colorMode != null) {
    ...
    public static Point findBestPreviewSizeValue(Camera.Parameters parameters, Point screenResolution) {
        ...
        while (it.hasNext()) {
            ...
            boolean isCandidatePortrait =
                (realWidth < realHeight && screenAspectRatio < 0) || (realWidth > realHeight && screenAspectRatio > 0);
